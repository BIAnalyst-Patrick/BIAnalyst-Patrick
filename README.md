...
Freelance/remote Business Intelligence & Data Analyst (operating as **Sting Analytics** on Fiverr/Upwork) · Open to remote BI/Data Analyst roles · Based in Nairobi, Kenya
...
| [Retail Demand Forecasting](https://github.com/BIAnalyst-Patrick/Retail-Demand-Forecasting) | Which forecasting method actually performs best on this data — not just which one we assumed would? | 4-model bake-off (Naive, Holt-Winters, SARIMA, Prophet); Prophet won at 6.88% MAPE |
...
| [Customer Retention & RFM Segmentation (SQL)](https://github.com/BIAnalyst-Patrick/SQL-Customer-Retention-RFM-Analysis) | Which customers actually drive revenue, and who's at risk of churning? | Pure SQL (CTEs, window functions): 9.6% of customers drive 19.4% of revenue; 1,255 churn-risk flags |
